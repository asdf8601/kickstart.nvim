...
return {
  -- Fuzzy Finder (files, lsp, etc)
  {
    ...
    init = function()
      ...
      vim.keymap.set('n', "<leader>fb", "<cmd>lua builtin.find_files( { cwd = vim.fn.expand('%:p:h'), hidden = false }) <CR>", { desc = "[telescope] Search files in current buffer dir", noremap = true })
